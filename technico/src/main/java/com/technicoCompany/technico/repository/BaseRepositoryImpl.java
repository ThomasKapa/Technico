...
import com.technicoCompany.technico.service.BaseServise;
...
public abstract class BaseRepositoryImpl<T extends BaseModel> extends BaseComponent implements BaseServise<T, Long> {
